...
func TestIngress(t *testing.T) {
	...
	defer k8s.RunKubectl(t, options, "label", "namespace", "default", "istio-injection-", "istio.io/rev-")
	...
	defer k8s.RunKubectl(t, options, "delete", "-k", kubeResourcePath)
	defer k8s.RunKubectl(t, options, "delete", "-k", kubeResourcePath_backend)
	defer k8s.RunKubectl(t, options, "delete", "-k", kubeResourcePath_frontend)
	...
	k8s.RunKubectl(t, options, "apply", "-k", kubeResourcePath)
	k8s.RunKubectl(t, options, "apply", "-k", kubeResourcePath_backend)
	k8s.RunKubectl(t, options, "apply", "-k", kubeResourcePath_frontend)
